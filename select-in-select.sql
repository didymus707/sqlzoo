...
SELECT name, continent, population 
FROM world x 
WHERE NOT EXISTS(SELECT population FROM world y WHERE y.continent = x.continentAND population > 25000000 )
...
SELECT name, continent 
FROM world x
WHERE population/3 > ALL(SELECT population FROM world y WHERE y.continent = x.continent AND x.name <> y.name)